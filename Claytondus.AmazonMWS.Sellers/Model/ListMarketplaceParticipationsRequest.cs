...
namespace Claytondus.AmazonMWS.Sellers.Model
{
    ...
    public class ListMarketplaceParticipationsRequest : AbstractMwsObject
    {
        ...
        public ListMarketplaceParticipationsRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public ListMarketplaceParticipationsRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Sellers/2011-07-01", "ListMarketplaceParticipationsRequest", this);
        }

        public ListMarketplaceParticipationsRequest() : base()
        {
        }
    }
}
