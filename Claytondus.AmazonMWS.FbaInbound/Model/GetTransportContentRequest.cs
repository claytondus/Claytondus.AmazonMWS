...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class GetTransportContentRequest : AbstractMwsObject
    {
        ...
        public GetTransportContentRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public GetTransportContentRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public GetTransportContentRequest WithShipmentId(string shipmentId)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetTransportContentRequest", this);
        }

    public GetTransportContentRequest (string sellerId,string shipmentId) : base() {
        this._sellerId = sellerId;
        this._shipmentId = shipmentId;
    }

        public GetTransportContentRequest() : base()
        {
        }
    }
}
