...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class VoidTransportInputRequest : AbstractMwsObject
    {
        ...
        public VoidTransportInputRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public VoidTransportInputRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public VoidTransportInputRequest WithShipmentId(string shipmentId)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "VoidTransportInputRequest", this);
        }

    public VoidTransportInputRequest (string shipmentId) : base() {
        this._shipmentId = shipmentId;
    }

        public VoidTransportInputRequest() : base()
        {
        }
    }
}
