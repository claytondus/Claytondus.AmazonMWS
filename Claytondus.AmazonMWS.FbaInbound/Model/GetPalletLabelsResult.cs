...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class GetPalletLabelsResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetPalletLabelsResult", this);
        }


        public GetPalletLabelsResult() : base()
        {
        }
    }
}
