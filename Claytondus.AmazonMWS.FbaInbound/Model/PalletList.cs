...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class PalletList : AbstractMwsObject
    {

        private List<Pallet> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElementAttribute(ElementName = "member")]
        public List<Pallet> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<Pallet>();
                }
                return this._member;
            }
        ...
        public PalletList Withmember(Pallet[] member)
        {
        ...
        {
            _member = reader.ReadList<Pallet>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "PalletList", this);
        }
