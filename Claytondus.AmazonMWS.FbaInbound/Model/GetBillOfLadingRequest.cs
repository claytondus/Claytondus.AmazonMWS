...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class GetBillOfLadingRequest : AbstractMwsObject
    {
        ...
        public GetBillOfLadingRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public GetBillOfLadingRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public GetBillOfLadingRequest WithShipmentId(string shipmentId)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetBillOfLadingRequest", this);
        }

    public GetBillOfLadingRequest (string sellerId,string shipmentId) : base() {
        this._sellerId = sellerId;
        this._shipmentId = shipmentId;
    }

        public GetBillOfLadingRequest() : base()
        {
        }
    }
}
