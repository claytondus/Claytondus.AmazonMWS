...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class EstimateTransportRequestResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "EstimateTransportRequestResult", this);
        }


        public EstimateTransportRequestResult() : base()
        {
        }
    }
}
