 ...
 *******************************************************************************
 * Confirm Transport Input Request
...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class ConfirmTransportInputRequest : AbstractMwsObject
    {
        ...
        public ConfirmTransportInputRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public ConfirmTransportInputRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public ConfirmTransportInputRequest WithShipmentId(string shipmentId)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ConfirmTransportInputRequest", this);
        }

    public ConfirmTransportInputRequest (string shipmentId) : base() {
        this._shipmentId = shipmentId;
    }

        public ConfirmTransportInputRequest() : base()
        {
        }
    }
}
