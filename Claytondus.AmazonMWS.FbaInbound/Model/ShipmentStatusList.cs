...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class ShipmentStatusList : AbstractMwsObject
    {
        ...
        public ShipmentStatusList Withmember(string[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ShipmentStatusList", this);
        }


        public ShipmentStatusList() : base()
        {
        }
    }
}
