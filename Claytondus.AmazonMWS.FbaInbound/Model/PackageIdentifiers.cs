...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class PackageIdentifiers : AbstractMwsObject
    {
        ...
        public PackageIdentifiers Withmember(string[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "PackageIdentifiers", this);
        }


        public PackageIdentifiers() : base()
        {
        }
    }
}
