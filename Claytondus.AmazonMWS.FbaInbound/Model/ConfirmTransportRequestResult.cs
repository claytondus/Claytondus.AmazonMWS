 ...
 *******************************************************************************
 * Confirm Transport Request Result
...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class ConfirmTransportRequestResult : AbstractMwsObject
    {
        ...
        public ConfirmTransportRequestResult WithTransportResult(TransportResult transportResult)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ConfirmTransportRequestResult", this);
        }


        public ConfirmTransportRequestResult() : base()
        {
        }
    }
}
