...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class UpdateInboundShipmentResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "UpdateInboundShipmentResult", this);
        }


        public UpdateInboundShipmentResult() : base()
        {
        }
    }
}
