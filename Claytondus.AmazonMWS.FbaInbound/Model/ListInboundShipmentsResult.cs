...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class ListInboundShipmentsResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ListInboundShipmentsResult", this);
        }


        public ListInboundShipmentsResult() : base()
        {
        }
    }
}
