...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class GetPackageLabelsResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetPackageLabelsResult", this);
        }


        public GetPackageLabelsResult() : base()
        {
        }
    }
}
