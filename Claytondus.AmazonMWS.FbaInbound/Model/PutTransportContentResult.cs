...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class PutTransportContentResult : AbstractMwsObject
    {
        ...
        public PutTransportContentResult WithTransportResult(TransportResult transportResult)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "PutTransportContentResult", this);
        }


        public PutTransportContentResult() : base()
        {
        }
    }
}
