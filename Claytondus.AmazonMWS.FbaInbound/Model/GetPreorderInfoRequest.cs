...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class GetPreorderInfoRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetPreorderInfoRequest", this);
        }


        public GetPreorderInfoRequest() : base()
        {
        }
    }
}
