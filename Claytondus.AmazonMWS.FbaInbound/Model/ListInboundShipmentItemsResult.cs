 ...
 *******************************************************************************
 * List Inbound Shipment Items Result
...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class ListInboundShipmentItemsResult : AbstractMwsObject
    {
        ...
        public ListInboundShipmentItemsResult WithItemData(InboundShipmentItemList itemData)
        {
        ...
        /// <returns>this instance.</returns>
        public ListInboundShipmentItemsResult WithNextToken(string nextToken)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ListInboundShipmentItemsResult", this);
        }


        public ListInboundShipmentItemsResult() : base()
        {
        }
    }
}
