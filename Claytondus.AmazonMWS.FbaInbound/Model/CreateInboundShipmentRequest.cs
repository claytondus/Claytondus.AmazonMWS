...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class CreateInboundShipmentRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "CreateInboundShipmentRequest", this);
        }

    public CreateInboundShipmentRequest (string sellerId,InboundShipmentHeader inboundShipmentHeader,InboundShipmentItemList inboundShipmentItems) : base() {
        this._sellerId = sellerId;
        this._inboundShipmentHeader = inboundShipmentHeader;
        this._inboundShipmentItems = inboundShipmentItems;
    }

        public CreateInboundShipmentRequest() : base()
        {
        }
    }
}
