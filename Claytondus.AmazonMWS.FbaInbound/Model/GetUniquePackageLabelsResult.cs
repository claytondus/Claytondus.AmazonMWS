 ...
 *******************************************************************************
 * Get Unique Package Labels Result
...
namespace Claytondus.AmazonMWS.FbaInbound.Model
{
    ...
    public class GetUniquePackageLabelsResult : AbstractMwsObject
    {
        ...
        public GetUniquePackageLabelsResult WithTransportDocument(TransportDocument transportDocument)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetUniquePackageLabelsResult", this);
        }


        public GetUniquePackageLabelsResult() : base()
        {
        }
    }
}
