...
namespace Claytondus.AmazonMWS.FbaInbound
{
    ...
    public class FBAInboundServiceMWSConfig {
        ...
        private const string DEFAULT_SERVICE_PATH = "FulfillmentInboundShipment/2010-10-01";
        ...
        /// <returns>this instance</returns>
        public FBAInboundServiceMWSConfig WithUserAgent(String userAgent)
        {
        ...
        /// May include the path to make MWS calls to. Defaults to FulfillmentInboundShipment/2010-10-01
        /// </summary>
        ...
        /// <returns>this instance</returns>
        public FBAInboundServiceMWSConfig WithServiceURL(string serviceURL)
        {
