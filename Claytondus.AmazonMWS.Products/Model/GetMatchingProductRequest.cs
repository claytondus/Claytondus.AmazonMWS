...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class GetMatchingProductRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetMatchingProductRequest", this);
        }

    public GetMatchingProductRequest (string sellerId,string marketplaceId,ASINListType asinList) : base() {
        this._sellerId = sellerId;
        this._marketplaceId = marketplaceId;
        this._asinList = asinList;
    }

        public GetMatchingProductRequest() : base()
        {
        }
    }
}
