...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class ASINOfferDetail : AbstractMwsObject
    {
        ...
        /// <returns>this instance.</returns>
        public ASINOfferDetail WithIsFulfilledByAmazon(bool isFulfilledByAmazon)
        {
        ...
        /// <returns>this instance.</returns>
        public ASINOfferDetail WithIsBuyBoxWinner(bool isBuyBoxWinner)
        {
        ...
        /// <returns>this instance.</returns>
        public ASINOfferDetail WithIsFeaturedMerchant(bool isFeaturedMerchant)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "ASINOfferDetail", this);
        }
