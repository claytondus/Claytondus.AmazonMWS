...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class GetCompetitivePricingForSKURequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetCompetitivePricingForSKURequest", this);
        }

    public GetCompetitivePricingForSKURequest (string sellerId,string marketplaceId,SellerSKUListType sellerSKUList) : base() {
        this._sellerId = sellerId;
        this._marketplaceId = marketplaceId;
        this._sellerSKUList = sellerSKUList;
    }

        public GetCompetitivePricingForSKURequest() : base()
        {
        }
    }
}
