...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class BuyBoxEligibleOffers : AbstractMwsObject
    {
        ...
        public BuyBoxEligibleOffers WithOfferCount(OfferCountType[] offerCount)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "BuyBoxEligibleOffers", this);
        }
