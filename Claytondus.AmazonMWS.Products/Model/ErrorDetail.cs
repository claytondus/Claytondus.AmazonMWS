...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class ErrorDetail : AbstractMwsObject
    {
        ...
        public ErrorDetail WithAny(Object[] any)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "ErrorDetail", this);
        }


        public ErrorDetail() : base()
        {
        }
    }
}
