...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class GetProductCategoriesForASINRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetProductCategoriesForASINRequest", this);
        }

    public GetProductCategoriesForASINRequest (string sellerId,string marketplaceId,string asin) : base() {
        this._sellerId = sellerId;
        this._marketplaceId = marketplaceId;
        this._asin = asin;
    }

        public GetProductCategoriesForASINRequest() : base()
        {
        }
    }
}
