...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class SKUOfferDetailList : AbstractMwsObject
    {

        private List<SKUOfferDetail> _offer;

        /// <summary>
        /// Gets and sets the Offer property.
        /// </summary>
        [XmlElementAttribute(ElementName = "Offer")]
        public List<SKUOfferDetail> Offer
        {
            get
            {
                if(this._offer == null)
                {
                    this._offer = new List<SKUOfferDetail>();
                }
                return this._offer;
            }
        ...
        public SKUOfferDetailList WithOffer(SKUOfferDetail[] offer)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "SKUOfferDetailList", this);
        }


        public SKUOfferDetailList() : base()
        {
        }
    }
}
