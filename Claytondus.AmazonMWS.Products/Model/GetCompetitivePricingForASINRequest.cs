...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class GetCompetitivePricingForASINRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetCompetitivePricingForASINRequest", this);
        }

    public GetCompetitivePricingForASINRequest (string sellerId,string marketplaceId,ASINListType asinList) : base() {
        this._sellerId = sellerId;
        this._marketplaceId = marketplaceId;
        this._asinList = asinList;
    }

        public GetCompetitivePricingForASINRequest() : base()
        {
        }
    }
}
