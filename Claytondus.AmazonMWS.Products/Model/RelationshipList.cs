...
namespace Claytondus.AmazonMWS.Products.Model
{
    ...
    public class RelationshipList : AbstractMwsObject
    {
        ...
        public RelationshipList WithAny(Object[] any)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Products/2011-10-01", "RelationshipList", this);
        }
