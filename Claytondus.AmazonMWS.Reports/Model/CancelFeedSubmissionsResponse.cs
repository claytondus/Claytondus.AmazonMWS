...
namespace MarketplaceWebService.Model
{
    ...
    public class CancelFeedSubmissionsResponse
    {
        ...
        private  CancelFeedSubmissionsResult cancelFeedSubmissionsResultField;
        private  ResponseMetadata responseMetadataField;

        /// <summary>
        /// Gets and sets the CancelFeedSubmissionsResult property.
        /// </summary>
        [XmlElementAttribute(ElementName = "CancelFeedSubmissionsResult")]
        public CancelFeedSubmissionsResult CancelFeedSubmissionsResult
        {
            get { return this.cancelFeedSubmissionsResultField ; }
            set { this.cancelFeedSubmissionsResultField = value; }
        }
        ...
        {
            this.cancelFeedSubmissionsResultField = cancelFeedSubmissionsResult;
            return this;
        }
        ...
        {
            return this.cancelFeedSubmissionsResultField != null;
        }
