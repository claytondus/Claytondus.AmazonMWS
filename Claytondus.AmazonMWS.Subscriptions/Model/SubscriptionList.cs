...
{
    public class SubscriptionList : AbstractMwsObject
    {

        private List<Subscription> _member;

        /// <summary>
        /// Gets and sets the Member property.
        /// </summary>
        public List<Subscription> Member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<Subscription>();
                }
                return this._member;
            }
        ...
        public SubscriptionList WithMember(Subscription[] member)
        {
        ...
        {
            _member = reader.ReadList<Subscription>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "SubscriptionList", this);
        }

        public SubscriptionList() : base()
        {
        }
    }
}
