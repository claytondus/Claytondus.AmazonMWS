...
{
    public class DestinationList : AbstractMwsObject
    {

        private List<Destination> _member;

        /// <summary>
        /// Gets and sets the Member property.
        /// </summary>
        public List<Destination> Member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<Destination>();
                }
                return this._member;
            }
        ...
        public DestinationList WithMember(Destination[] member)
        {
        ...
        {
            _member = reader.ReadList<Destination>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "DestinationList", this);
        }
