 ...
 *******************************************************************************
 * Send Test Notification To Destination Input
...
{
    public class SendTestNotificationToDestinationInput : AbstractMwsObject
    {
        ...
        public SendTestNotificationToDestinationInput WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public SendTestNotificationToDestinationInput WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public SendTestNotificationToDestinationInput WithMarketplaceId(string marketplaceId)
        {
        ...
        /// <returns>this instance.</returns>
        public SendTestNotificationToDestinationInput WithDestination(Destination destination)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "SendTestNotificationToDestinationInput", this);
        }

        public SendTestNotificationToDestinationInput() : base()
        {
        }
    }
}
