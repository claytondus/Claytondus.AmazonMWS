...
{
    public class ListSubscriptionsInput : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "ListSubscriptionsInput", this);
        }

        public ListSubscriptionsInput() : base()
        {
        }
    }
}
