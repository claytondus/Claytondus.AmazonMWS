...
{
    public class GetSubscriptionInput : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "GetSubscriptionInput", this);
        }

        public GetSubscriptionInput() : base()
        {
        }
    }
}
