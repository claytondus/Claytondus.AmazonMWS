...
{
    public class UpdateSubscriptionInput : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "UpdateSubscriptionInput", this);
        }

        public UpdateSubscriptionInput() : base()
        {
        }
    }
}
