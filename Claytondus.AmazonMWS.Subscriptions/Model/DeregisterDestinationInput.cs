...
{
    public class DeregisterDestinationInput : AbstractMwsObject
    {
        ...
        public DeregisterDestinationInput WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public DeregisterDestinationInput WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public DeregisterDestinationInput WithMarketplaceId(string marketplaceId)
        {
        ...
        /// <returns>this instance.</returns>
        public DeregisterDestinationInput WithDestination(Destination destination)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "DeregisterDestinationInput", this);
        }

        public DeregisterDestinationInput() : base()
        {
        }
    }
}
