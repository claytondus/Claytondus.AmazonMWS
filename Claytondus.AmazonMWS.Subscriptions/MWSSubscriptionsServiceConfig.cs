...
namespace Claytondus.AmazonMWS.Subscriptions
{
    ...
    /// </summary>
    public class MWSSubscriptionsServiceConfig {

        private const string DEFAULT_SERVICE_PATH = "Subscriptions/2013-07-01";
        private const string SERVICE_VERSION = "2013-07-01";
        ...
        /// <returns>this instance</returns>
        public MWSSubscriptionsServiceConfig WithUserAgent(String userAgent)
        {
        ...
        /// May include the path to make MWS calls to. Defaults to Subscriptions/2013-07-01
        /// </summary>
        ...
        /// <returns>this instance</returns>
        public MWSSubscriptionsServiceConfig WithServiceURL(string serviceURL)
        {
        ...
        public MWSSubscriptionsServiceConfig WithRequestHeader(string name, string value)
        {
            cc.IncludeRequestHeader(name, value);
            return this;
        }
