...
namespace MarketplaceWebService.Model
{
    ...
    public class GetReportListByNextTokenResult
    {
        ...
        public GetReportListByNextTokenResult WithNextToken(String nextToken)
        {
        ...
        /// <returns>this instance</returns>
        public GetReportListByNextTokenResult WithHasNext(Boolean hasNext)
        {
        ...
        /// <returns>this instance</returns>
        public GetReportListByNextTokenResult WithReportInfo(params ReportInfo[] list)
        {
