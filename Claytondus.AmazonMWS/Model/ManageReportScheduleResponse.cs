...
namespace MarketplaceWebService.Model
{
    ...
    public class ManageReportScheduleResponse
    {
        ...
        private  ManageReportScheduleResult manageReportScheduleResultField;
        private  ResponseMetadata responseMetadataField;

        /// <summary>
        /// Gets and sets the ManageReportScheduleResult property.
        /// </summary>
        [XmlElementAttribute(ElementName = "ManageReportScheduleResult")]
        public ManageReportScheduleResult ManageReportScheduleResult
        {
            get { return this.manageReportScheduleResultField ; }
            set { this.manageReportScheduleResultField = value; }
        }
        ...
        {
            this.manageReportScheduleResultField = manageReportScheduleResult;
            return this;
        }
        ...
        {
            return this.manageReportScheduleResultField != null;
        }
