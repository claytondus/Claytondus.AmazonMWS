...
namespace Claytondus.AmazonMWS.FbaOutbound
{
    ...
    /// </summary>
    public class FBAOutboundServiceMWSConfig {

        private const string DEFAULT_SERVICE_PATH = "FulfillmentOutboundShipment/2010-10-01";
        ...
        public FBAOutboundServiceMWSConfig WithSignatureMethod(string signatureMethod)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithSignatureVersion(string signatureVersion)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithUserAgent(String userAgent)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithUserAgent(string applicationName, string applicationVersion)
        {
        ...
        /// May include the path to make MWS calls to. Defaults to FulfillmentOutboundShipment/2010-10-01
        /// </summary>
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithServiceURL(string serviceURL)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithProxyHost(string proxyHost)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithProxyPort(int proxyPort)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithProxyUsername(string proxyUsername)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithProxyPassword(string proxyPassword)
        {
        ...
        /// <returns>this instance</returns>
        public FBAOutboundServiceMWSConfig WithMaxErrorRetry(int maxErrorRetry)
        {
        ...
        public FBAOutboundServiceMWSConfig WithRequestHeader(string name, string value)
        {
            cc.IncludeRequestHeader(name, value);
            return this;
        }
