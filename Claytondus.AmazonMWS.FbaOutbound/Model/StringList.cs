...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class StringList : AbstractMwsObject
    {
        ...
        public StringList Withmember(string[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "StringList", this);
        }
