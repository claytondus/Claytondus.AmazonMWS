...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class CreateReturnItemList : AbstractMwsObject
    {

        private List<CreateReturnItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<CreateReturnItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<CreateReturnItem>();
                }
                return this._member;
            }
        ...
        public CreateReturnItemList Withmember(CreateReturnItem[] member)
        {
        ...
        {
            _member = reader.ReadList<CreateReturnItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "CreateReturnItemList", this);
        }
