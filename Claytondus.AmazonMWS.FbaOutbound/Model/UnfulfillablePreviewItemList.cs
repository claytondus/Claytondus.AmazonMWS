...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class UnfulfillablePreviewItemList : AbstractMwsObject
    {

        private List<UnfulfillablePreviewItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<UnfulfillablePreviewItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<UnfulfillablePreviewItem>();
                }
                return this._member;
            }
        ...
        public UnfulfillablePreviewItemList Withmember(UnfulfillablePreviewItem[] member)
        {
        ...
        {
            _member = reader.ReadList<UnfulfillablePreviewItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "UnfulfillablePreviewItemList", this);
        }
