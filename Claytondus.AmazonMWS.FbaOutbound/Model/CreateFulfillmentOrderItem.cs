...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class CreateFulfillmentOrderItem : AbstractMwsObject
    {
        ...
        public CreateFulfillmentOrderItem WithSellerSKU(string sellerSKU)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithSellerFulfillmentOrderItemId(string sellerFulfillmentOrderItemId)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithQuantity(decimal quantity)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithGiftMessage(string giftMessage)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithDisplayableComment(string displayableComment)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithFulfillmentNetworkSKU(string fulfillmentNetworkSKU)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithOrderItemDisposition(string orderItemDisposition)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithPerUnitDeclaredValue(Currency perUnitDeclaredValue)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithPerUnitPrice(Currency perUnitPrice)
        {
        ...
        /// <returns>this instance.</returns>
        public CreateFulfillmentOrderItem WithPerUnitTax(Currency perUnitTax)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "CreateFulfillmentOrderItem", this);
        }

    public CreateFulfillmentOrderItem (string sellerSKU,string sellerFulfillmentOrderItemId,decimal quantity) : base() {
        this._sellerSKU = sellerSKU;
        this._sellerFulfillmentOrderItemId = sellerFulfillmentOrderItemId;
        this._quantity = quantity;
    }

        public CreateFulfillmentOrderItem() : base()
        {
        }
    }
}
