 ...
 *******************************************************************************
 * Create Fulfillment Order Item List
...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class CreateFulfillmentOrderItemList : AbstractMwsObject
    {

        private List<CreateFulfillmentOrderItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<CreateFulfillmentOrderItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<CreateFulfillmentOrderItem>();
                }
                return this._member;
            }
        ...
        public CreateFulfillmentOrderItemList Withmember(CreateFulfillmentOrderItem[] member)
        {
        ...
        {
            _member = reader.ReadList<CreateFulfillmentOrderItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "CreateFulfillmentOrderItemList", this);
        }
