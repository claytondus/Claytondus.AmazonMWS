...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class InvalidReturnItemList : AbstractMwsObject
    {

        private List<InvalidReturnItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<InvalidReturnItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<InvalidReturnItem>();
                }
                return this._member;
            }
        ...
        public InvalidReturnItemList Withmember(InvalidReturnItem[] member)
        {
        ...
        {
            _member = reader.ReadList<InvalidReturnItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "InvalidReturnItemList", this);
        }
