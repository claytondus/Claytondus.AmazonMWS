 ...
 *******************************************************************************
 * Fulfillment Shipment Item List
...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentShipmentItemList : AbstractMwsObject
    {

        private List<FulfillmentShipmentItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentShipmentItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentShipmentItem>();
                }
                return this._member;
            }
        ...
        public FulfillmentShipmentItemList Withmember(FulfillmentShipmentItem[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentShipmentItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentShipmentItemList", this);
        }
