...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentShipmentList : AbstractMwsObject
    {

        private List<FulfillmentShipment> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentShipment> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentShipment>();
                }
                return this._member;
            }
        ...
        public FulfillmentShipmentList Withmember(FulfillmentShipment[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentShipment>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentShipmentList", this);
        }
