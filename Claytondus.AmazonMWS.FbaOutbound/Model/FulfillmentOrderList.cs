...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentOrderList : AbstractMwsObject
    {

        private List<FulfillmentOrder> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentOrder> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentOrder>();
                }
                return this._member;
            }
        ...
        public FulfillmentOrderList Withmember(FulfillmentOrder[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentOrder>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentOrderList", this);
        }
