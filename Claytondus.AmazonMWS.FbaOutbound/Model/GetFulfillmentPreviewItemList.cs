 ...
 *******************************************************************************
 * Get Fulfillment Preview Item List
...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class GetFulfillmentPreviewItemList : AbstractMwsObject
    {

        private List<GetFulfillmentPreviewItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<GetFulfillmentPreviewItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<GetFulfillmentPreviewItem>();
                }
                return this._member;
            }
        ...
        public GetFulfillmentPreviewItemList Withmember(GetFulfillmentPreviewItem[] member)
        {
        ...
        {
            _member = reader.ReadList<GetFulfillmentPreviewItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "GetFulfillmentPreviewItemList", this);
        }
