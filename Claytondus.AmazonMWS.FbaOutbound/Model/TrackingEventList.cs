...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class TrackingEventList : AbstractMwsObject
    {

        private List<TrackingEvent> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<TrackingEvent> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<TrackingEvent>();
                }
                return this._member;
            }
        ...
        public TrackingEventList Withmember(TrackingEvent[] member)
        {
        ...
        {
            _member = reader.ReadList<TrackingEvent>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "TrackingEventList", this);
        }
