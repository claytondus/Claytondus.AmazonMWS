...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class ReturnItemList : AbstractMwsObject
    {

        private List<ReturnItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<ReturnItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<ReturnItem>();
                }
                return this._member;
            }
        ...
        public ReturnItemList Withmember(ReturnItem[] member)
        {
        ...
        {
            _member = reader.ReadList<ReturnItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "ReturnItemList", this);
        }
