...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FeeList : AbstractMwsObject
    {

        private List<Fee> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<Fee> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<Fee>();
                }
                return this._member;
            }
        ...
        public FeeList Withmember(Fee[] member)
        {
        ...
        {
            _member = reader.ReadList<Fee>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FeeList", this);
        }
