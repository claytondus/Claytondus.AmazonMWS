...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class DeliveryWindowList : AbstractMwsObject
    {

        private List<DeliveryWindow> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<DeliveryWindow> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<DeliveryWindow>();
                }
                return this._member;
            }
        ...
        public DeliveryWindowList Withmember(DeliveryWindow[] member)
        {
        ...
        {
            _member = reader.ReadList<DeliveryWindow>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "DeliveryWindowList", this);
        }
