...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class ShippingSpeedCategoryList : AbstractMwsObject
    {
        ...
        public ShippingSpeedCategoryList Withmember(string[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "ShippingSpeedCategoryList", this);
        }
