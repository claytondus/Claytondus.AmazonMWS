...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class ReturnAuthorizationList : AbstractMwsObject
    {

        private List<ReturnAuthorization> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<ReturnAuthorization> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<ReturnAuthorization>();
                }
                return this._member;
            }
        ...
        public ReturnAuthorizationList Withmember(ReturnAuthorization[] member)
        {
        ...
        {
            _member = reader.ReadList<ReturnAuthorization>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "ReturnAuthorizationList", this);
        }
