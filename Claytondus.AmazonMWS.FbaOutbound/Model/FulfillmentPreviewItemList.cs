...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentPreviewItemList : AbstractMwsObject
    {

        private List<FulfillmentPreviewItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentPreviewItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentPreviewItem>();
                }
                return this._member;
            }
        ...
        public FulfillmentPreviewItemList Withmember(FulfillmentPreviewItem[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentPreviewItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentPreviewItemList", this);
        }
