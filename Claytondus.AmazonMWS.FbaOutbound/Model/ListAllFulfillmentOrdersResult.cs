 ...
 *******************************************************************************
 * List All Fulfillment Orders Result
...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class ListAllFulfillmentOrdersResult : AbstractMwsObject
    {
        ...
        public ListAllFulfillmentOrdersResult WithNextToken(string nextToken)
        {
        ...
        /// <returns>this instance.</returns>
        public ListAllFulfillmentOrdersResult WithFulfillmentOrders(FulfillmentOrderList fulfillmentOrders)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "ListAllFulfillmentOrdersResult", this);
        }


        public ListAllFulfillmentOrdersResult() : base()
        {
        }
    }
}
