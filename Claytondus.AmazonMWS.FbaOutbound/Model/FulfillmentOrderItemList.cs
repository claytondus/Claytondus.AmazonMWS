...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentOrderItemList : AbstractMwsObject
    {

        private List<FulfillmentOrderItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentOrderItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentOrderItem>();
                }
                return this._member;
            }
        ...
        public FulfillmentOrderItemList Withmember(FulfillmentOrderItem[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentOrderItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentOrderItemList", this);
        }
