...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class UpdateFulfillmentOrderItemList : AbstractMwsObject
    {

        private List<UpdateFulfillmentOrderItem> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<UpdateFulfillmentOrderItem> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<UpdateFulfillmentOrderItem>();
                }
                return this._member;
            }
        ...
        public UpdateFulfillmentOrderItemList Withmember(UpdateFulfillmentOrderItem[] member)
        {
        ...
        {
            _member = reader.ReadList<UpdateFulfillmentOrderItem>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "UpdateFulfillmentOrderItemList", this);
        }
