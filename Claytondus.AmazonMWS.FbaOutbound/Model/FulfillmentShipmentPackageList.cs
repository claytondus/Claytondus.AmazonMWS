...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentShipmentPackageList : AbstractMwsObject
    {

        private List<FulfillmentShipmentPackage> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentShipmentPackage> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentShipmentPackage>();
                }
                return this._member;
            }
        ...
        public FulfillmentShipmentPackageList Withmember(FulfillmentShipmentPackage[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentShipmentPackage>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentShipmentPackageList", this);
        }
