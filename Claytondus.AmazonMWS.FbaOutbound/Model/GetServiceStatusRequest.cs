...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class GetServiceStatusRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "GetServiceStatusRequest", this);
        }

    public GetServiceStatusRequest (string sellerId) : base() {
        this._sellerId = sellerId;
    }
