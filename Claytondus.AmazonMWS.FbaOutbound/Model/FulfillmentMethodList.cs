...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentMethodList : AbstractMwsObject
    {
        ...
        public FulfillmentMethodList Withmember(string[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentMethodList", this);
        }


        public FulfillmentMethodList() : base()
        {
        }
    }
}
