...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class FulfillmentPreviewShipmentList : AbstractMwsObject
    {

        private List<FulfillmentPreviewShipment> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<FulfillmentPreviewShipment> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<FulfillmentPreviewShipment>();
                }
                return this._member;
            }
        ...
        public FulfillmentPreviewShipmentList Withmember(FulfillmentPreviewShipment[] member)
        {
        ...
        {
            _member = reader.ReadList<FulfillmentPreviewShipment>("member");
        }
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "FulfillmentPreviewShipmentList", this);
        }
