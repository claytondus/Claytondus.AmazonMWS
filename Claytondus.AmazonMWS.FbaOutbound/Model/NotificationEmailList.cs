...
namespace Claytondus.AmazonMWS.FbaOutbound.Model
{
    ...
    public class NotificationEmailList : AbstractMwsObject
    {
        ...
        public NotificationEmailList Withmember(string[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "NotificationEmailList", this);
        }
