...
{
    public class CreateShipmentResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("https://mws.amazonservices.com/MerchantFulfillment/2015-06-01", "CreateShipmentResult", this);
        }
    ...
    public CreateShipmentResult (Shipment shipment) : base() {
        ...
        public CreateShipmentResult() : base()
        {
        }
    }
}
