...
{
    public class CancelShipmentRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("https://mws.amazonservices.com/MerchantFulfillment/2015-06-01", "CancelShipmentRequest", this);
        }

    public CancelShipmentRequest (string sellerId,string shipmentId) : base() {
        this._sellerId = sellerId;
        this._shipmentId = shipmentId;
    }

        public CancelShipmentRequest() : base()
        {
        }
    }
}
