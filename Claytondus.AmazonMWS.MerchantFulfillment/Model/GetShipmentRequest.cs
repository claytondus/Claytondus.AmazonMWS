...
{
    public class GetShipmentRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("https://mws.amazonservices.com/MerchantFulfillment/2015-06-01", "GetShipmentRequest", this);
        }

    public GetShipmentRequest (string sellerId,string shipmentId) : base() {
        this._sellerId = sellerId;
        this._shipmentId = shipmentId;
    }

        public GetShipmentRequest() : base()
        {
        }
    }
}
