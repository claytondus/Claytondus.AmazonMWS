...
namespace Claytondus.AmazonMWS.MerchantFulfillment
{
    ...
    /// </summary>
    public class MWSMerchantFulfillmentServiceConfig {

        private const string DEFAULT_SERVICE_PATH = "MerchantFulfillment/2015-06-01";
        private const string SERVICE_VERSION = "2015-06-01";
        ...
        public MWSMerchantFulfillmentServiceConfig WithSignatureMethod(string signatureMethod)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithSignatureVersion(string signatureVersion)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithUserAgent(String userAgent)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithUserAgent(string applicationName, string applicationVersion)
        {
        ...
        /// May include the path to make MWS calls to. Defaults to MerchantFulfillment/2015-06-01
        /// </summary>
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithServiceURL(string serviceURL)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithProxyHost(string proxyHost)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithProxyPort(int proxyPort)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithProxyUsername(string proxyUsername)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithProxyPassword(string proxyPassword)
        {
        ...
        /// <returns>this instance</returns>
        public MWSMerchantFulfillmentServiceConfig WithMaxErrorRetry(int maxErrorRetry)
        {
        ...
        public MWSMerchantFulfillmentServiceConfig WithRequestHeader(string name, string value)
        {
            cc.IncludeRequestHeader(name, value);
            return this;
        }
