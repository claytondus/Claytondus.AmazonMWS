...
namespace Claytondus.AmazonMWS.FbaInventory.Model
{
    ...
    public class InventorySupplyList : AbstractMwsObject
    {

        private List<InventorySupply> _member;

        /// <summary>
        /// Gets and sets the member property.
        /// </summary>
        [XmlElement(ElementName = "member")]
        public List<InventorySupply> member
        {
            get
            {
                if(this._member == null)
                {
                    this._member = new List<InventorySupply>();
                }
                return this._member;
            }
        ...
        public InventorySupplyList Withmember(InventorySupply[] member)
        {
        ...
        {
            writer.Write("http://mws.amazonaws.com/FulfillmentInventory/2010-10-01/", "InventorySupplyList", this);
        }

        public InventorySupplyList() : base()
        {
        }
    }
}
