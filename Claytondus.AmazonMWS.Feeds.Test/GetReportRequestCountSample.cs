...
namespace Claytondus.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportRequestCountSample
    {
        ...
        public static async Task InvokeGetReportRequestCount(MarketplaceWebService service, GetReportRequestCountRequest request)
        {
            try 
            {
                GetReportRequestCountResponse response = await service.GetReportRequestCount(request);
