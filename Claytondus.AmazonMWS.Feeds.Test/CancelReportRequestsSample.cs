...
namespace Claytondus.AmazonMWS.Feeds.Test
{
    ...
    public class CancelReportRequestsSample
    {
        ...
        public static async Task InvokeCancelReportRequests(MarketplaceWebService service, CancelReportRequestsRequest request)
        {
            try 
            {
                CancelReportRequestsResponse response = await service.CancelReportRequests(request);
                ...
                Console.WriteLine("        CancelReportRequestsResponse");

                if (response.IsSetCancelReportRequestsResult()) 
                {
                    Console.WriteLine("            CancelReportRequestsResult");
