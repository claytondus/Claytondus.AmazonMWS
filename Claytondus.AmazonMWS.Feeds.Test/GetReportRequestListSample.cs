...
namespace Claytondus.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportRequestListSample
    {
        ...
        public static async Task InvokeGetReportRequestList(MarketplaceWebService service, GetReportRequestListRequest request)
        {
            try 
            {
                GetReportRequestListResponse response = await service.GetReportRequestList(request);
