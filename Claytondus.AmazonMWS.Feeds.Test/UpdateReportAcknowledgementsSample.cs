...
namespace Claytondus.AmazonMWS.Feeds.Test
{
    ...
    public class UpdateReportAcknowledgementsSample
    {
        ...
        public static async Task InvokeUpdateReportAcknowledgements(MarketplaceWebService service, UpdateReportAcknowledgementsRequest request)
        {
            try 
            {
                UpdateReportAcknowledgementsResponse response = await service.UpdateReportAcknowledgements(request);
