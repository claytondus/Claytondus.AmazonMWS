...
{
    public class ListFinancialEventGroupsByNextTokenRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("http://mws.amazonservices.com/Finances/2015-05-01", "ListFinancialEventGroupsByNextTokenRequest", this);
        }

    public ListFinancialEventGroupsByNextTokenRequest (string nextToken) : base() {
        this._nextToken = nextToken;
    }

        public ListFinancialEventGroupsByNextTokenRequest() : base()
        {
        }
    }
}
